    ...
    return(<>
        <div className={style.main}>
            ...
            <div className={style.barHolder}>
                ...
                <div className={style.tab}><div className={style.imgHolder}><img src={revolverIcon}/></div><h4>REVOLVERS</h4></div>
                <div className={style.tab}><div className={style.imgHolder}><img src={shotgunIcon}/></div><h4>SHOTGUNS</h4></div>
